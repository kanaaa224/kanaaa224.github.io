        ...
        setup() {
            ...
            const loadRepos = async () => {
                try {
                    ...
                    const result = await callAPI(`${'https://api.github.com/users/kanaaa224'}/repos?per_page=${REPOS_PER_PAGE}&page=${currentPage}`);
            ...
            onMounted(async () => {
                ...
                try {
                    developer.value = await callAPI('https://api.github.com/users/kanaaa224');
                } catch(e) {
                    console.error(e);
                }
