            ...
            <v-main>
                <transition name="fade">
                    <v-container v-if="container_visible">
                        ...
                        <v-card class="pa-6" elevation="0" rounded="lg">
                            <div class="d-flex flex-column flex-md-row align-md-center justify-md-space-between">
                                ...
                                <div class="d-flex justify-center justify-md-end flex-wrap">
                                    ...
                                    ><v-icon>mdi-soundcloud</v-icon></v-btn>
                                    <v-btn
                                        icon variant="plain"
                                        target="_blank"
                                        rel="noopener"
                                    ...
                                    ><v-icon>mdi-sony-playstation</v-icon></v-btn>
                                    <v-btn
                                        icon variant="plain"
                                        target="_blank"
                                        rel="noopener"
                                        href="//discord.com/users/551228674784100361"
                                    ><i class="bi bi-discord"></i></v-btn>
                                    <v-btn
                                        icon variant="plain"
                                        target="_blank"
                                        rel="noopener"
                        ...
                        <v-card class="card-shadow pa-2 mt-10" elevation="0" rounded="lg" id="links">
